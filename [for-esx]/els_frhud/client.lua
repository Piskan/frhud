...
Citizen.CreateThread(function()
    ...
    -- PlayerData =  ESX.GetPlayerData() ------------------- if you need restart open this
...
-- RegisterCommand("armoradd", function()
       ...
       if PlayerData ~= nil then
            ...
            if (Config.OpenSettings.needhud and needhudaktif == true and not IsPauseMenuActive()) then
                ...
                TriggerEvent('esx_status:getStatus', 'hunger', function(status)
                    gecerlideger["hunger"]  = status.val/1000000*100
                end)
                TriggerEvent('esx_status:getStatus', 'thirst', function(status)
                    gecerlideger["thirst"] = status.val/1000000*100
                end)
